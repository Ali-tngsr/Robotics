"""
PHASE 5: SIMULATIONS
Five scenarios from Amouri et al. 2020 & Extension
(Refactored: Centralized Imports, Modular PID, SMC, and Dependency Injection for m_p)
"""
import numpy as np
...
# وارد کردن کنترلرها از فایل‌های مستقل
...
# ─────────────────────────────────────────────────────────────────────────────
# 7. EXTENSION: SMC CONTROL (Robustness against Payload)
# ─────────────────────────────────────────────────────────────────────────────
